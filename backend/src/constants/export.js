...
const EXPORT_PERMISSIONS = [
  ...
  permission("export.products.view", "products.view", "View export products"),
  permission("export.products.create", "products.create", "Create export products"),
  permission("export.products.update", "products.update", "Update export products"),
  permission("export.products.delete", "products.delete", "Delete export products"),
...
const EXPORT_MANAGER_PERMISSIONS = [
  ...
  "export.products.create",
  "export.products.update",
  "export.products.delete",
